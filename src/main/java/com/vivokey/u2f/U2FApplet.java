...
public class U2FApplet extends Applet implements ExtendedLength {
    ...
    public U2FApplet() {
        ...
        counters = new Counter[] { new Counter(), new Counter(), new Counter(), new Counter(), new Counter(),
        ...
        try {
            scratch = JCSystem.makeTransientByteArray((short) (SCRATCH_PAD + SCRATCH_PAD_SIZE),
    ...
    private void handleEnroll(APDU apdu) throws ISOException {
        ...
        short keyHandleLength = fidoImpl.generateKeyAndWrap(buffer,
                (short) (dataOffset + APDU_APPLICATION_PARAMETER_OFFSET), scratch, SCRATCH_PUBLIC_KEY_OFFSET, scratch,
                SCRATCH_KEY_HANDLE_OFFSET, (byte) (next_counter++ & COUNTER_MASK));
        ...
        short signatureSize = ctapImpl.attestation.sign(buffer, (short) 0, (short) 0, scratch,
        ...
        if (extendedLength) {
            ...
            Util.setShort(scratch, SCRATCH_FULL_LENGTH,
                    (short) (outOffset + ctapImpl.attestation.x509len + signatureSize));
    ...
    private void handleSign(APDU apdu) throws ISOException {
        ...
        byte counter_index = fidoImpl.unwrap(buffer, (short) (dataOffset + 65), keyHandleLength, buffer,
    ...
    private void handleVersion(APDU apdu) throws ISOException {
        byte[] buffer = apdu.getBuffer();
        Util.arrayCopyNonAtomic(Utf8Strings.UTF8_U2F, (short) 0, buffer, (short) 0,
                (short) Utf8Strings.UTF8_U2F.length);
    ...
    private void handleGetData(APDU apdu) throws ISOException {
        ...
        if ((scratch[SCRATCH_TRANSPORT_STATE] == TRANSPORT_NOT_EXTENDED_CERT) && (requestedSize != (short) 0)) {
            short blockSize = ((short) (ctapImpl.attestation.x509len - currentOffset) > requestedSize ? requestedSize
                    : (short) (ctapImpl.attestation.x509len - currentOffset));
